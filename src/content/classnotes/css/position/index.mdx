...
<CodeHtmlCssPreview code="/codes/css/position/position-static" />

## Relative positioning

<CodeHtmlCssPreview code="/codes/css/position/position-relative" />

Propriedades: top, bottom, left, right, z-index

<CodeHtmlCssPreview code="/codes/css/position/z-index" />

## Absolute positioning

<CodeHtmlCssPreview code="/codes/css/position/position-absolute" />

Positioning contexts (Closest positioned)

<CodeHtmlCssPreview code="/codes/css/position/position-static-absolute" />

<CodeHtmlCssPreview code="/codes/css/position/position-relative-absolute" />

<CodeHtmlCssPreview code="/codes/css/position/position-relative-relative-absolute" />

## Fixed positioning

<CodeHtmlCssPreview code="/codes/css/position/position-fixed" height={200} />

## Sticky positioning

<CodeHtmlCssPreview code="/codes/css/position/position-sticky" height={200} />

## Stretch a Box

### Absolute inside Absolute, with Fixed Dimensions

<CodeHtmlCssPreview code="/codes/css/position/fixed-height-static-static" />

### Absolute Inside Relative, with Fixed Dimensions

<CodeHtmlCssPreview code="/codes/css/position/fixed-height-relative-absolute" />

### Absolute Inside Relative Without a Specific Height

<CodeHtmlCssPreview code="/codes/css/position/strech-height-relative-absolute" />

## Float

<CodeHtmlCssPreview code="/codes/css/position/float" />
