...
[img/hexagonal-pattern.jpg](/lm/codes/css/background/bg-image/img/hexagonal-pattern.jpg) ([Source](https://www.freepik.com/free-vector/hexagonal-pattern_852781.htm#term=seamless%20pattern&page=1&position=2)):
...
[repeat](/lm/codes/css/background/bg-repeat/index.html):
...
[no-repeat](/lm/codes/css/background/bg-no-repeat/index.html):
...
[bg-position/](/lm/codes/css/background/bg-position/index.html) ([Source](https://developer.mozilla.org/en-US/docs/Learn/CSS/Styling_text/Styling_links#Including_icons_on_links)):
...
[Resultado](/lm/codes/css/background/bg-attachment/index.html):
...
[Resultado](/lm/codes/css/background/image-filters/index.html):
...
[Resultado](/lm/codes/css/background/image-opacity/index.html):
