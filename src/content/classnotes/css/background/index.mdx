...
[img/hexagonal-pattern.jpg](/public/lm/codes/css/background/bg-image/img/hexagonal-pattern.jpg) ([Source](https://www.freepik.com/free-vector/hexagonal-pattern_852781.htm#term=seamless%20pattern&page=1&position=2)):
...
<CodeHtmlCssPreview src="/codes/css/background/bg-image-linear-gradient" />

Radial Gradient:

<CodeHtmlCssPreview src="/codes/css/background/bg-image-radial-gradient" />
...
[img/pattern.png](/lm/codes/css/background/bg-repeat/img/pattern.png) ([Source](https://www.freepik.com/free-vector/zig-zag-background-with-pastel-colors_1795073.htm)):
...
<CodeHtmlCssPreview src="/codes/css/background/bg-size" />
...
<CodeHtmlCssPreview src="/codes/css/background/bg-blend-mode" />
...
<CodeHtmlCssPreview src="/codes/css/background/image-filters" />
