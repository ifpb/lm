...
<CodeHtmlCssPreview code="/codes/css/box-model/box-sizing" codeCss={false} />
...
<CodeHtmlCssPreview code="/codes/css/box-model/overflow" codeCss={false} />
...
| Style                     | Preview                                                           |
| ------------------------- | ----------------------------------------------------------------- |
| outline: solid;           | <div style={{outline: 'solid'}}>Lorem ipsum dolor</div>           |
| outline: #f66 dashed;     | <div style={{outline: '#f66 dashed'}}>Lorem ipsum dolor</div>     |
| outline: green solid 3px; | <div style={{outline: 'green solid 3px'}}>Lorem ipsum dolor</div> |
