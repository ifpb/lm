...
<CodeHtmlCssPreview src="/codes/css/box-model/table" />
...
| Style                    | Preview                                                                                                                                       |
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------- |
| box-sizing: content-box; | <div style={{boxSizing: 'content-box', border: "1px solid #000", width: '200px', padding: '1rem'}}>Lorem ipsum dolor amet, consectetur.</div> |
| box-sizing: border-box;  | <div style={{boxSizing: 'border-box', border: "1px solid #000", width: '200px', padding: '1rem'}}>Lorem ipsum dolor amet, consectetur.</div>  |
...
| Style              | Preview                                                                                                                                 |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------- |
| overflow: visible; | <div style={{overflow: 'visible', border: "1px solid #000", width: '200px', height: '2rem'}}>Lorem ipsum dolor amet, consectetur.</div> |
| overflow: hidden;  | <div style={{overflow: 'hidden', border: "1px solid #000", width: '200px', height: '2rem'}}>Lorem ipsum dolor amet, consectetur.</div>  |
| overflow: scroll;  | <div style={{overflow: 'scroll', border: "1px solid #000", width: '200px', height: '2rem'}}>Lorem ipsum dolor amet, consectetur.</div>  |
| overflow: auto;    | <div style={{overflow: 'auto', border: "1px solid #000", width: '200px', height: '2rem'}}>Lorem ipsum dolor amet, consectetur.</div>    |
