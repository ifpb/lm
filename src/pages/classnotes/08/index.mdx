...
[img/hexagonal-pattern.jpg](/codes/background/bg-image/img/hexagonal-pattern.jpg) ([Source](https://www.freepik.com/free-vector/hexagonal-pattern_852781.htm#term=seamless%20pattern&page=1&position=2)):

![](/codes/background/bg-image/img/hexagonal-pattern.jpg)
...
<HyperText src="/codes/background/bg-image/index.html" />
...
<HyperText src="/codes/background/bg-image-linear-gradient/index.html" />
...
<HyperText src="/codes/background/bg-image-radial-gradient/index.html" />
...
<HyperText src="/codes/background/bg-image-multiple/index.html" />
...
![](/codes/background/bg-repeat/img/pattern.png)

[repeat](/codes/background/bg-repeat/index.html):
...
<HyperText src="/codes/background/bg-repeat/index.html" height="150" />

[no-repeat](/codes/background/bg-no-repeat/index.html):
...
<HyperText src="/codes/background/bg-no-repeat/index.html" height="150" />
...
[bg-position/](/codes/background/bg-position/index.html) ([Source](https://developer.mozilla.org/en-US/docs/Learn/CSS/Styling_text/Styling_links#Including_icons_on_links)):
...
<HyperText src="/codes/background/bg-position/index.html" />
...
![](/codes/background/bg-size/img/image.jpg)
...
<HyperText src="/codes/background/bg-size/index.html" />
...
[Resultado](/codes/background/bg-attachment/index.html):

<HyperText src="/codes/background/bg-attachment/index.html" height="400" />
...
<HyperText src="/codes/background/bg-blend-mode/index.html" />
...
![](/codes/background/sprite/img/google.png)
...
<HyperText src="/codes/background/sprite/index.html" />
...
[Resultado](/codes/background/image-filters/index.html):

<HyperText src="/codes/background/image-filters/index.html" />
...
[Resultado](/codes/background/image-opacity/index.html):

<HyperText src="/codes/background/image-opacity/index.html" />
